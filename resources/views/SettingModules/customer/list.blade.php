<x-app-layout title="Settings : Customer List">
    <x-slot name="script">
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                window.LoadData = function(customRoute, routeSufix) {
                    let route = "/settings/customer/list-data";
                    if (customRoute) {
                        route = customRoute;
                    }
                    if (routeSufix) {
                    ...
                    let databulder = new DataBuilder(dataWrap, {
                        ...
                        columns: {
                            name: {
                                ...
                                filter: function(data, row) {
                                    return `<a class='popup' data-w="500"  href="/settings/customer/update/${row.id}">${row.name}</a>`;
                                }
                            },
                            email: {
                                visible: true,
                        ...
                        actions: {
                            edit: {
                                url: "/settings/customer/update/{id}",
                                title: 'Edit',
                                class: "popup",
                                attr: {
                                    "data-w": "500",
                            ...
                            delete: {
                                url: "/settings/customer/delete/{id}",
                                title: 'Delete',
                                class: "",
                                attr: {
        ...
        <div class="data-table-wrap">
            <div class="data-table-header">
                ...
                <div class="data-controller">
                    <a class="btn-new popup" data-w='500' href="{{ URL('settings/customer/new') }}"><svg
